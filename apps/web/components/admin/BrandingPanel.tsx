      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <h2 className="text-lg font-bold flex items-center gap-2">
            <Palette className="h-5 w-5 text-primary" /> Marca &amp; White-label
          </h2>
          <p className="text-sm text-muted-foreground mt-0.5">
            Personalize o nome, logotipo, cores e ícone do sistema. As mudanças se aplicam a todos os usuários.
          </p>
        </div>
        <button
